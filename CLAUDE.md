...
**Còn thiếu / cần user cung cấp**: danh mục thùng thật (trong/ngoài cm, bì g, tải g, giá), số đo từng SKU sau gấp/bọc + quy cách xếp, danh mục vật tư (g, giá), đơn vị vận chuyển + hệ số quy đổi + bảng cước. Giới hạn còn lại: `picking-list` vẫn tra hồ sơ đóng gói (SKU chưa đo làm picking-list 422); chưa có nhánh túi mailer, chia nhiều kiện, snapshot/version hồ sơ, job tự động (BE-5).
