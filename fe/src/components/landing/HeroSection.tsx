    ...
    <section className="relative overflow-hidden px-4 pt-16 pb-12 sm:px-6 sm:pt-24 sm:pb-16">
      ...
      <div className="relative mx-auto max-w-4xl text-center">
        ...
        <p className="mx-auto mt-5 max-w-2xl text-base text-ink-muted sm:text-lg">
          Gộp đơn đa kênh từ Shopee, TikTok Shop và Facebook. Loại bỏ khoảng trống
          thừa trong kiện hàng nhờ thuật toán AI 3D Bin Packing.
        </p>
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-4 text-xs text-ink-subtle">
